...
function getDefaultAttributes(resource: Node<NamedQueryFiles, NamedQueryAttributes>): NamedQueryAttributes {
    return {
...
export const namedQuery = newFolderResource<NamedQueryFiles, NamedQueryAttributes>(
    'named-query',
    { scope: 'DG', version: 2 },
